...
**External review:** After internal sharpening, run concepts past external reviewers for adversarial critique. They'll push on: existing work you missed, failure modes you didn't consider, real-world constraints you haven't accounted for.
