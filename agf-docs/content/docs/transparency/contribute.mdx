...
The [canonical `CONTRIBUTING.md`](https://github.com/jessepike/agf/blob/main/CONTRIBUTING.md) on GitHub is the source of truth. This page summarizes the highest-leverage contribution paths. For the decision-authority model and the planned evolution beyond v0.x, see [Governance](/docs/transparency/governance).
...
| `docs/profiles/` | Yes | Domain-specific profiles (security, GRC, platform, AI engineering, observability) |
| `docs/white-papers/` | Yes | Deep-dive topics |
| `diagrams/` | Yes | Architecture diagrams |
| `agf-docs/` | Yes | Documentation site improvements |
| `intent.md` | Discussion only | Project philosophy. Propose changes via Discussion, not PR. |
