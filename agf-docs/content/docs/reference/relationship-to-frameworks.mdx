...
This page describes AGF's position in the broader landscape — the contract surface AGF commits to. Where the page references "operationalize at machine speed," treat that as the architectural commitment; the schedule of machine-form artifacts beyond the shipped [GDR schema](/docs/reference/governance-decision-record) lives on the [Roadmap](/docs/transparency/roadmap).
</Confidence>
...
| **5** | What does a production implementation look like? | Microsoft AGT (MIT, ATF-conformant), Azure CAF, Agent 365 (GA May 1, 2026 per [Microsoft](https://blogs.microsoft.com/blog/2026/04/21/accelerating-frontier-transformation-with-microsoft-partners/); verify current status on Microsoft Learn) |
