...
- **Operationalizes** — emits machine-readable forms of its primitives alongside human-readable forms (the dual-form principle). At gate boundaries this materializes as a [Governance Decision Record (GDR)](/docs/reference/governance-decision-record) — see DECISIONS.md #5, #8, and #9 for the full vocabulary.
