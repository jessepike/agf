...
- **Operationalizes** — emits machine-readable forms of its primitives alongside human-readable forms (the dual-form principle). Load-bearing at gate boundaries: every gate decision emits both forms simultaneously.
