...
| **0** (substrate) | How do the pieces fit together architecturally for an agentic system? | **AGF** — 4 Rings + 19 Primitives + 3 deployment modes + 3-level security model + 7 tensions + OTAA (Observable · Traceable · Auditable · Agent-operable) |
