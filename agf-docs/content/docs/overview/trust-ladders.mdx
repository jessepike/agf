...
*Trust Ladders are Primitive #11 in the AGF pattern catalog. For the complete framework including all 19 primitives and the Rings Model, see the [Reference Architecture](/docs/reference/architecture). For how governance gates interact with trust levels, see [Governance Gates](/docs/reference/primitives).*
