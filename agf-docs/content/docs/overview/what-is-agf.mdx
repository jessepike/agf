...
AGF synthesizes — it does not decree. Every claim carries one of [three confidence levels](/docs/reference/confidence-levels) so you can audit where AGF stands on the evidence: <Confidence level="established" /> · <Confidence level="informed" /> · <Confidence level="open" />.
...
- [Pick your role](/#roles) — five domain profiles, each with the depth your function needs
