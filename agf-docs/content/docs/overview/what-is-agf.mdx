...
AGF synthesizes — it does not decree. Load-bearing empirical and novel claims carry one of [three confidence levels](/docs/reference/confidence-levels) so you can audit where AGF stands on the evidence: <Confidence level="established" /> · <Confidence level="informed" /> · <Confidence level="open" />.
