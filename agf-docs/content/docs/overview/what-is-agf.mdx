...
- **Rigor before opinion.** Every claim is labeled with one of [three confidence levels](/docs/reference/confidence-levels) so you can audit where AGF stands on evidence: <Confidence level="established" /> · <Confidence level="informed" /> · <Confidence level="open" />.
