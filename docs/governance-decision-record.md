...
- **EU AI Act Art. 12 (Record-keeping)** — GDRs are durable records of governance decisions affecting high-risk AI systems; they support the Art. 12 logging requirement when retention and integrity controls meet the regulatory standard. (See `relationship-to-frameworks.md` for AGF's broader Art. 12 evidence story across primitives.)
...
- **ISO 42001** — GDRs support the documented information requirements (Clause 7.5) and the management review requirements (Clause 9.3) where governance decisions need to be evidenced.
